...
const jeffData = {
    ...
    Buffalo_Bills: 28.53,
    Detroit_Lions: 29.22,
    Kansas_City_Chiefs: 26.11,
    Houston_Texans: 20.94,
    Baltimore_Ravens: 28.04,
    Philadelphia_Eagles: 27.86,
    Miami_Dolphins: 21.8,
    Green_Bay_Packers: 27.59,
    Cincinnati_Bengals: 22.27,
    New_York_Jets: 16.65,
    Los_Angeles_Rams: 23.03,
    Dallas_Cowboys: 16.82,
    Jacksonville_Jaguars: 15.80,
    Pittsburgh_Steelers: 20.60,
    Cleveland_Browns: 13.39,
    Chicago_Bears: 16.73,
    Seattle_Seahawks: 20.83,
    Indianapolis_Colts: 16.41,
    Atlanta_Falcons: 18.51,
    Minnesota_Vikings: 25.22,
    Arizona_Cardinals: 18.86,
    Los_Angeles_Chargers: 22.52,
    Tampa_Bay_Buccaneers: 23.22,
    Tennessee_Titans: 13.28,
    New_Orleans_Saints: 13.96,
    Washington_Commanders: 21.39,
    Las_Vegas_Raiders: 14.66,
    New_England_Patriots: 12.44,
    Denver_Broncos: 20.72,
