...
const jeffData = {
    San_Francisco_49ers: 24.37,
    Buffalo_Bills: 26.37,
    Detroit_Lions: 28.29,
    Kansas_City_Chiefs: 26.26,
    Houston_Texans: 22.82,
    Baltimore_Ravens: 25.35,
    Philadelphia_Eagles: 24.18,
    Miami_Dolphins: 18.38,
    Green_Bay_Packers: 24.2,
    Cincinnati_Bengals: 20.68,
    New_York_Jets: 20.33,
    Los_Angeles_Rams: 20.97,
    Dallas_Cowboys: 18.36,
    Jacksonville_Jaguars: 18.00,
    Pittsburgh_Steelers: 23.36,
    Cleveland_Browns: 16.36,
    Chicago_Bears: 20.4,
    Seattle_Seahawks: 19.08,
    Indianapolis_Colts: 20.01,
    Atlanta_Falcons: 20.03,
    Minnesota_Vikings: 23.3,
    Arizona_Cardinals: 20.1,
    Los_Angeles_Chargers: 21.18,
    Tampa_Bay_Buccaneers: 19.82,
    Tennessee_Titans: 15.02,
    New_Orleans_Saints: 14.53,
    Washington_Commanders: 20.83,
    Las_Vegas_Raiders: 13.0,
    New_England_Patriots: 13.02,
    Denver_Broncos: 17.63,
    New_York_Giants: 14.19,
    Carolina_Panthers: 9.38,
};
