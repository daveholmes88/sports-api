...
const jeffData = {
    San_Francisco_49ers: 24.09,
    Buffalo_Bills: 24.49,
    Detroit_Lions: 24.70,
    Kansas_City_Chiefs: 26.00,
    Houston_Texans: 23.02,
    Baltimore_Ravens: 24.2,
    Philadelphia_Eagles: 22.01,
    Miami_Dolphins: 18.51,
    Green_Bay_Packers: 23.47,
    Cincinnati_Bengals: 20.07,
    New_York_Jets: 21.88,
    Los_Angeles_Rams: 18.77,
    Dallas_Cowboys: 20.69,
    Jacksonville_Jaguars: 17.74,
    Pittsburgh_Steelers: 21.67,
    Cleveland_Browns: 16.48,
    Chicago_Bears: 21.14,
    Seattle_Seahawks: 19.69,
    Indianapolis_Colts: 19.94,
    Atlanta_Falcons: 20.50,
    Minnesota_Vikings: 24.1,
    Arizona_Cardinals: 18.6,
    Los_Angeles_Chargers: 18.97,
    Tampa_Bay_Buccaneers: 19.61,
    Tennessee_Titans: 17.18,
    New_Orleans_Saints: 19.39,
    Washington_Commanders: 19.72,
    Las_Vegas_Raiders: 13.97,
    New_England_Patriots: 14.00,
    Denver_Broncos: 18.41,
    New_York_Giants: 16.19,
    Carolina_Panthers: 10.88,
};
